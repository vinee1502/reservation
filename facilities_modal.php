        ...
        <div class="modal-header">
         ...
         <div class="modal-body">
                <div class="padd">
					...
					<p>2. Additional 10% payment on reservation outside Talisay City.</p>
					...
					<p>8. Terms of payments will be via padala center cebuana or palawan center or personal payments.
close</p>
				</div>
        </div>
